...
const ActaSchema = new Schema(
  {
    ...
    miembrosPresentes: [{ ref: 'Participante', type: Schema.Types.ObjectId }],
    miembrosInvitados: [{ ref: 'Participante', type: Schema.Types.ObjectId }],
    miembrosAusentes: [{ ref: 'Participante', type: Schema.Types.ObjectId }],
    documentosSoporte: [
      {
